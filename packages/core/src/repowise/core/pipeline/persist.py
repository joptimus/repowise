...
async def persist_pipeline_result(
    ...
    # ---- Prune stale file-scoped rows (full run only) -----------------------
    # graph/analysis tables key off parsed_files; git_metadata keys off the git
    # indexer's file set (a file can be git-tracked but unparsed).
